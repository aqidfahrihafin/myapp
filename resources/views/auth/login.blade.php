<!doctype html> <link rel="shortcut icon" href="assets/images/logo1.png">
<html lang="en">
...
<head>
    ...
    <meta content="BeMall" name="description">
                ...
                <div class="col-md-8 col-lg-5 col-xl-5">
                    <div class="overflow-hidden card">
                        ...
                        <div class="pt-0 card-body">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" action="{{ 'dashboard-wali' }}">
                                    ...
                                    <div class="mt-4 text-center">
                                        <a href="{{ '/lupapw' }}" class="text-muted"><i
                                                class="mr-1 mdi mdi-lock"></i> Forgot your password?</a>
